...
class AboutWhy extends Component {
  componentDidMount() {
    this.updateCanvas();
  }
          ...
          <div className="about__why-content-left">
            <div className="about__why-content-leftfirst">
              ...
              <div className="about__why-content-left__content">
                Bring your own nbn-ready modem or buy our awesome nbn-ready
                modem from us. Change your plan anytime for free or stick with
                the same one. We’ll always recommend the right plan for you,
                even if that means you pay less.
              </div>
            </div>
            <div className="about__why-content-leftsecond">
              ...
              <div className="about__why-content-left__content">
                Our customers are at the heart of everything we do. Got a
                question? Ask away. Need support? We’re here to help 365.2425
                days a year.
              </div>
            </div>
          </div>
          <div className="about__why-content__center">
            <canvas ref="outer" width={394} height={394} />
          ...
          <div className="about__why-content-right">
            <div className="about__why-content-rightfirst">
              ...
              <div className="about__why-content-right__content">
                Buy our awesome plug & play nbn-ready modem from us. It’s
                unlocked and you’ll always get the best price. We’d love for you
                to stay, but if you do decide to leave you can take your modem
                with you at anytime (and transfer your nbn service) as we don’t
            ...
            <div className="about__why-content-rightsecond">
              ...
              <div className="about__why-content-right__content">
                We’re the David amongst Goliaths in telco-land. Big carrier
                networks have had it too good for too long. We may be
                sort-of-small, but we’re big on that caring, sharing thing.
              </div>
            </div>
          </div>
        </div>
