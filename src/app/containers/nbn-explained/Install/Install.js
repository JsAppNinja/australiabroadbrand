    ...
    <div className="nbn-install">
      <div className="nbn-install__left">
        ...
        <div className="nbn-install__left-content">
          ...
          <br />
          <br />
          Where inside the house you’d like to have your new nbn™ connection
          box. Ideally, this will be less than three metres from where you’ll
          keep your nbn™ compatible Wi-Fi Modem.
          <br />
          <br />
          If your place has been connected to the nbn™ through a Fibre to the
          Node (FTTN) or Building (FTTB) or Curb (FTTC) connection, the NBN Co
          will take over and use your existing telephone line to connect your
          place to the nbn™. This means NBN Co will likely not have to install
          anything inside your place to get you connected.
        </div>
      </div>
      <div className="nbn-install__right">
        ...
        <img
          className="nbn-install__right-img"
          src={NBN_Install1}
          alt="qprem"
        />
