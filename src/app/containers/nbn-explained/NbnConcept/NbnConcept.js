...
const NbnConcept = () => (
  <div className="nbnconcept">
      ...
      <div className="nbnconcept__explained">
        <div className="nbnconcept__explained-first">
          <div className="nbnconcept_exlained-txt">
            ...
            internet network. It’s designed to provide you with access to all
            the benefits of fast and reliable internet services, wherever you
            live.
            <br />
            <br />
        ...
        <div className="nbnconcept__explained-second">
          ...
          <div className="nbnconcept_exlained-txt">
            ...
            infrastructure in place; then as an authorised nbn™ service
            provider, Australia Broadband gets you connected to the nbn™.
            <br />
            <br />
    ...
    <Container className="bg_concept">
      <div className="nbnconcept__understanding">
        ...
        <div className="nbnconcept__understanding-txt">
          ...
          <div className="nbnconcept__understanding-txt__second">
            ...
            Historically internet speeds for Australia was determined by where
            you lived and how far your place was from your local Telstra
            exchange. In fact, most Australians using ADSL only received an
            average download speed of less than 10 Mbps.
            <br />
            <br />
