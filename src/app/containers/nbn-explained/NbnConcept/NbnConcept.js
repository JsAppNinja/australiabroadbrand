    ...
    <div className="nbnconcept__explained">
      <div className="nbnconcept__explained-first">
        <div className="nbnconcept_exlained-txt">
          The nbn™ network is Australia’s new landline phone and internet
          network. It’s designed to provide you with access to all the benefits
          of fast and reliable internet services, wherever you live. Over the
          coming months and years as the National Broadband Network (nbn™) is
          rolled out, many parts of Australia’s existing telephone network will
          be switched off. To ensure your landline phone or internet is not
          affected and take advantage of the faster speeds and reliability of
          the nbn™, you must switch from your current internet service provider
          to an authorised nbn™ service provider.
        </div>
      ...
      <div className="nbnconcept__explained-second">
        ...
        <div className="nbnconcept_exlained-txt">
          ...
          Australia Broadband gets you connected to the nbn™. NBN Co is a was
          established on 9 April 2009 to implement the Australian Government’s
          policy initiative of providing a National Broadband Network.
        </div>
      </div>
    </div>
